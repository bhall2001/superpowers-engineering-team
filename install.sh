...
# Install SET reference files
mkdir -p "$COMMANDS_DIR/references"

cat > "$COMMANDS_DIR/references/enhanced-builder-prompt.md" << 'SETEOF'
# Enhanced Builder Prompt
...
```
SETEOF
info "Installed references/enhanced-builder-prompt.md"

cat > "$COMMANDS_DIR/references/enhanced-qa-prompt.md" << 'SETEOF'
# Enhanced QA Prompt
